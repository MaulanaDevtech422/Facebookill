...
system("clear")
print ("++++++++++++++++++++++++++++++++++++++")
print ("| AUTHOR   : MaulanDevtech           |")
print ("| Support  : kunjungi konten kami    |")
print ("| WEBSITE  : imtech.com              |")
print ("| Email    : technocode422@gmail.com |")
print ("++++++++++++++++++++++++++++++++++++++")
class YC:
    ...
    def __getToken(self):
        data = {
            ...
            "v":"1.0"}
        sig = (f'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail={self.email}format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod>
        x = hashlib.new('md5')
        x.update(sig)
        data.update({
            "sig": x.hexdigest()
